...
ActiveRecord::Schema.define(version: 20170724074936) do
  ...
  add_index "been_heres", ["restaurant_id"], name: "index_been_heres_on_restaurant_id"
  ...
  add_index "bookmarks", ["restaurant_id"], name: "index_bookmarks_on_restaurant_id"
  ...
  add_index "recommends", ["restaurant_id"], name: "index_recommends_on_restaurant_id"
